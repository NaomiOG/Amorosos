...
class baseDatos
{
	...
	function inicializa($serv="localhost",$user="root",$puser="",$bd="amoroso"){ #Todo elemento de información dentro de un método es LOCAL (Pertenece AL MÉTODO). Por ello debe usarse this, para indicar que se hace referencia a un atributo DE LA CLASE 
	...
	function generarPwd(){
	    ...
	    $mail->Username =   "17030622@itcelaya.edu.mx"; // SMTP account username
	    $mail->Password = "fcdr220814dprpepe";  // SMTP account password
